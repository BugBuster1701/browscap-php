...
[![Latest Stable Fork Version](https://img.shields.io/badge/stable-7.2.3-blue.svg)](https://packagist.org/packages/bugbuster/browscap-php#7.2.3)

Fork: Special version for Contao 5.3 and PHP 8.3/8.4 with Monolog 2.9, used by the Contao BotDetection Bundle.
